...
const SectionHeading = ({ title }) => (
  <h2 className="text-2xl font-bold uppercase text-purple-700 border-b border-gray-300 pb-2 mt-8 mb-5">
    {title}
  </h2>
);
  ...
  return (
    ...
    >
      ...
      <div className="border-b-4 border-purple-600 pb-6">
        ...
        <h2 className="text-2xl text-purple-600 mt-2">
          {title}
        </h2>
      ...
      {/* Product Tools */}
      <SectionHeading title="Product Tools" />
      ...
      {/* Product Launches */}
      <SectionHeading title="Product Launches" />
      ...
      {projects.map((project, index) => (
        <div key={index} className="mb-8">
          ...
          <p className="text-purple-600 text-sm mt-2">
            Impact: {project.techStack}
          </p>
        </div>
      ))}

      {/* Key Product Metrics */}
      <SectionHeading title="Key Product Metrics" />
