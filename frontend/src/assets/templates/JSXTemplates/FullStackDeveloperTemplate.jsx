...
const SectionHeading = ({ title }) => (
  <h2 className="text-2xl font-bold uppercase text-indigo-700 border-b border-gray-300 pb-2 mt-8 mb-5">
    {title}
  </h2>
);

const FullStackDeveloperTemplate = ({ data }) => {
  const {
    name,
    title,
    email,
  ...
  return (
    ...
    >
      ...
      <div className="border-b-4 border-indigo-600 pb-6">
        ...
        <h2 className="text-2xl text-indigo-600 mt-2">
          {title}
        </h2>
        ...
        <div className="flex flex-wrap gap-6 mt-3 text-indigo-600 text-sm">
          {github && <p>{github}</p>}
      ...
      {/* Development Tools */}
      <SectionHeading title="Development Tools" />
