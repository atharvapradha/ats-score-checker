...
const SectionHeading = ({ title }) => (
  <h2 className="text-2xl font-bold uppercase text-pink-600 border-b border-gray-300 pb-2 mt-8 mb-5">
    {title}
  </h2>
);

const DigitalMarketingTemplate = ({ data }) => {
  const {
    name,
    title,
    email,
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="border-b-4 border-pink-500 pb-6">
        <h1 className="text-5xl font-bold">
          {name}
        </h1>

        <h2 className="text-2xl text-pink-600 mt-2">
          {title}
        </h2>
      ...
      {/* Marketing Skills */}
      <SectionHeading title="Marketing Skills" />
      ...
      {/* Marketing Campaigns */}
      <SectionHeading title="Marketing Campaigns" />
      ...
      {/* Social Profiles */}
      <SectionHeading title="Social Profiles" />
