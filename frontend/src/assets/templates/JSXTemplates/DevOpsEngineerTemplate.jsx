...
const SectionHeading = ({ title }) => (
  <h2 className="text-2xl font-bold uppercase text-blue-700 border-b border-gray-300 pb-2 mt-8 mb-5">
    {title}
  </h2>
);

const DevOpsEngineerTemplate = ({ data }) => {
  const {
    name,
    title,
    email,
